...
import (
	...
	"github.com/DesistDaydream/prometheus-instrumenting/cmd/gdas_exporter/collector"
...
func main() {
	...
	// ######## 设置命令行标志，开始 ########
	// ####################################
	listenAddress := pflag.String("web.listen-address", ":18003", "Address to listen on for web interface and telemetry.")
