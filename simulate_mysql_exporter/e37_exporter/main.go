...
import (
	...
	"github.com/DesistDaydream/prometheus-instrumenting/simulate_mysql_exporter/e37_exporter/collector"
...
var scrapers = map[scraper.CommonScraper]bool{
	collector.ScrapeBuckets{}: true,
	collector.ScrapeUsers{}:   true,
}
