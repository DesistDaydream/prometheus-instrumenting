...
func (o *XskyOpts) AddFlag() {
	pflag.StringVar(&o.URL, "hw_obs-server", "https://172.20.6.100:8088", "HTTP API address of a Xsky server or agent. (prefix with https:// to connect over HTTPS)")
	pflag.StringVar(&o.Username, "hw_obs-user", "admin", "hw_obs username")
	pflag.StringVar(&o.password, "hw_obs-pass", "", "hw_obs password")
